...
class SmartTag {
    ...
    public function __construct(modX $modx, $config = array()) {
        ...
        $basePath = $this->modx->getOption('smarttag.core_path', $config, $this->modx->getOption('core_path') . 'components/smarttag/');
        $assetsUrl = $this->modx->getOption('smarttag.assets_url', $config, $this->modx->getOption('assets_url') . 'components/smarttag/');
        ...
        $this->modx->lexicon->load('smarttag:default');
        $tablePrefix = $this->modx->getOption('smarttag.table_prefix', null, $this->modx->config[modX::OPT_TABLE_PREFIX] . 'smarttag_');
        $this->modx->addPackage('smarttag', $this->config['modelPath'], $tablePrefix);
    }
