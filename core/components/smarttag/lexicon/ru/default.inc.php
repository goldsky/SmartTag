 ...
 * @subpackage i18n
 */
$_lang['setting_smarttag.limit'] = 'Лимит списка тегов';
$_lang['setting_smarttag.limit_desc'] = 'Лимит запросов из списка тегов в Пользовательской странице менеджера (CMP).По умолчанию 50.';
$_lang['setting_smarttag.use_filter'] = 'Использовать фильтра';
$_lang['setting_smarttag.use_filter_desc'] = 'Включить фильтр спец. символов в псевдониме для тегов.По умолчанию - вкл.';

$_lang['smarttag'] = 'SmartTag';
$_lang['smarttag_desc'] = 'База тегов';